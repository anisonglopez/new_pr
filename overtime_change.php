...
<div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <dl class="row">
                                ...
                                <dd class="col-sm-8 info-box-label">
                                <input name="OVT10" type="number" data-placement="top"  class="form-control"  min="0"  step="any" value="'.$rows["OVT10"].'"/>   
                                </dd>
                            </dl>
                        </div>  
                        <div class="col-md-6">
                            <dl class="row">
                                ...
                                <dd class="col-sm-8 info-box-label">
                                <input name="OVT15" type="number" data-placement="top"  class="form-control"  min="0"  step="any" value="'.$rows["OVT15"].'"/>   
                                </dd>
                            </dl>
                        </div>  
                        <div class="col-md-6">
                            <dl class="row">
                                ...
                                <dd class="col-sm-8 info-box-label">
                                <input name="OVT20" type="number" data-placement="top"  class="form-control"  min="0"  step="any" value="'.$rows["OVT20"].'"/>   
                                </dd>
                            </dl>
                        </div>  
                        <div class="col-md-6">
                            <dl class="row">
                                ...
                                <dd class="col-sm-8 info-box-label">
                                <input name="OVT25" type="number" data-placement="top"  class="form-control"  min="0"  step="any" value="'.$rows["OVT25"].'"/>   
                                </dd>
                            </dl>
                        </div>  
                        <div class="col-md-6">
                            <dl class="row">
                                ...
                                <dd class="col-sm-8 info-box-label">
                                <input name="OVT30" type="number" data-placement="top"  class="form-control"  min="0"  step="any" value="'.$rows["OVT30"].'"/>   
                                </dd>
                            </dl>
                        </div>  
