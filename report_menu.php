                    ...
                    <div class="panel panel-default">
                       ...
                       <table width="100%" class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    <td style="text-align : center;">   
                                    <button class="btn btn-primary" data-toggle="modal" data-target="#modal_short_pay_slip"><span class="glyphicon glyphicon-download" aria-hidden="true"></span> ดาวน์โหลด</button>
                                    <!-- Button trigger modal -->
                                    </td>
                                    <td>พิมพ์ใบจ่ายเงินเดือนแบบย่อ (Pay Slip)</td> 
                                 </tr>
...
<!-- Modal short pay slip -->
<!-- Modal -->
<div class="modal fade" id="modal_short_pay_slip" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document" style="width: 800px;">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="exampleModalLabel">พิมพ์ใบจ่ายเงินเดือนแบบย่อ (Pay Slip)</h3>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="report_pdf/payslip_short_report.php" method="get" target="_blank">
      <div class="modal-body">
        <div class="row">
            <div class="col-md-12">
                    <dl class="row">
