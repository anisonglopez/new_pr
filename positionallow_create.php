        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form class="form-inline" name="create" method="post"  action="positionallow_create_acc.php" enctype="multipart/form-data" autocomplete="off">
                       ...
                       <option value="">Select</option>   
                        ...
                        <div class="col-md-6">
                            <dl class="row">
                                ...
                                <dd class="col-sm-8 info-box-label">
                                <input name="PosiAllow" type="number" data-placement="top" required  class="form-control" min="0"  value="0"/>
                                </dd>
                            </dl>
                        </div>      
                        <div class="col-md-6">
